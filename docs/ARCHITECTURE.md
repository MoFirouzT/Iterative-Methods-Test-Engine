...
The architecture reference is now a **Documenter site**, split into one page per module
for easier reading. The content that used to live in this single file now lives under
[`docs/src/`](src/) and is published to GitHub Pages.
...
- **Browse the sources on GitHub:**
  ...
  - Modules — [Problem Interface](src/modules/problem-interface.md) ·
